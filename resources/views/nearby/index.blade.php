        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="content-page-title">
                    <i class="fa fa-map-marker"></i>Trouver des personnes à proximité
                </div>
                ...
                <div class="content-page-blue-title">
                    A trouvé {{ $nearby->count() }} Personnes dans une gamme de 50 km!
                </div>

                @if($nearby->count() == 0)
                    <div class="alert-message alert-message-danger">
                        <h4>Les personnes ne sont pas trouvées.</h4>
                    </div>
                @else
                    <div class="row">
