...
<div class="panel panel-default new-post-box">
    <div class="panel-body">
        <form id="form-new-post">
            ...
            <textarea name="content" placeholder="Partagez ce que vous pensez ou vos photos"></textarea>
            ...
            <div class="row">
                <div class="col-xs-4">
                    <button type="button" class="btn btn-default btn-add-image btn-sm" onclick="uploadPostImage()">
                        <i class="fa fa-image"></i> Ajouter une image
                    </button>
